...
<div class="column">
<br><br><br><br><br>
<img src="img3" width="450" height="550">
</div>
</div>
<div id="university">
    ...
    if (isset($_POST['submit'])) {
        // Get user's GRE score
        $userScore = intval($_POST['greScore']);
        
        // Compare user's GRE score against cutoffs
        echo "<h2>Shortlisted Universities:</h2>";
        foreach ($universities as $university => $cutoff) {
            if ($userScore >= $cutoff) {
                echo "<p>$university</p>";
            }
        }
...
<img src="contact1.png" width="350" height="450">
</div>
</div>
<footer>
<br><br><br><br><br><br>
...
<table width="50%%">
<tr>
<td><center><img src="deeksha.jpeg" width="200px"><br><br>Deekshitha M</center></td>
</tr>
</table>
</center>
</footer>
